...
from specialk.classifier.onmt.Dict import Dict
from specialk.classifier.onmt.Optim import Optim
from specialk.classifier.onmt.Translator_cnn import Translator as Translator_cnn
