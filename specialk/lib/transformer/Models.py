...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        # for consistency's sake we'll call this the
        # generator, which takes the decoder output
        # and produces the one-hot output.
        self.generator = nn.Linear(d_model, n_tgt_vocab, bias=False)
        ...
        if tgt_emb_prj_weight_sharing:
            ...
            self.generator.weight = self.decoder.tgt_word_emb.weight
