...
from metrics.style_transfer.utils import calculate_correlations, get_val_as_str, load_dataset, load_turk_scores, merge_datasets
import numpy as np
...
if __name__ == "__main__":
    ...
    unmasked_inputs, inputs_with_style_removed, inputs_with_style_masked = generate_style_modified_texts(input_neg_texts)
    unmasked_outputs,outputs_with_style_removed,outputs_with_style_masked = generate_style_modified_texts(input_pos_texts)
    ...
    scores_styleremoved = calculate_wmd_scores(inputs_with_style_removed, outputs_with_style_removed, w2v_model)
    scores_stylemasked = calculate_wmd_scores(inputs_with_style_masked, outputs_with_style_masked, w2v_model_style_masked)

    scores_stylemasked = calculate_wmd_scores(inputs_with_style_masked, inputs_with_style_masked, w2v_model_style_masked)
