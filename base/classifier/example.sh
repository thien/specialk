...
python3 cnn_translate.py -gpu 0 -model $BESTMODEL -src ../../datasets/political_data/political_data/democratic_only.test.en -tgt 'democratic' -label0 democratic -label1 republican
