...
def extract_ranked_features(
    nonzero_weights, feature_numbers, inverse_vocabulary, weighted_feature_numbers
):
    """
...
def collect_style_features_and_weights(
    weights,
    styles,
    inverse_vocabulary,
    feature_numbers,
    ...
    for style_number, style_weights in enumerate(weights):
        ...
        selected_feature_numbers = select_feature_numbers(
            style_weights, number_of_standard_deviations
        )
        weighted_feature_numbers = feature_numbers[style_number][
            selected_feature_numbers
        ]
        ranked_features = extract_ranked_features(
            style_weights,
            selected_feature_numbers,
            inverse_vocabulary,
...
def load_lexicon():
    ...
    style_features_and_weights_path = "../style_lexicon/style_words_and_weights.json"
