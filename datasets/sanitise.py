...
def load_args():
    ...
    parser.add_argument("-cutoff", default=0.6, help="Cutoff ratio for filtering.")
...
if __name__ == "__main__":
    ...
    bad_i = {
        i
        for i in tqdm(range(len(before)), desc=filt_desc)
        if not en_filter(before[i][fi], opt.cutoff)
    }
