...
python3 train_decoder.py -gpus 0 -data data/democratic_generator.train.pt -save_model trained_models/democratic_generator -classifier_model ../models/classifier/political_classifier/political_classifier.pt -encoder_model ../models/translation/french_english/french_english.pt -tgt_label 1

# # Translate the republican test set using the best democratic generator
python3 translate.py -gpu 0 -encoder_model ../models/translation/french_english/french_english.pt -decoder_model ../models/style_generators/democratic_generator.pt -src ../data/political_data/republican_only.test.fr -output trained_models/republican_democratic.txt -replace_unk $true

# python3 translate.py -gpu 0 -model $FRENG -src ../data/political_data/republican_only.test.fr -output trained_models/republican_democratic.txt -replace_unk $true
